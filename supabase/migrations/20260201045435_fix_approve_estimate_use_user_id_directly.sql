/*
  # Fix Approve/Deny Estimate Functions - Use user_id Directly

  1. Changes
    - Remove fetching of user_profiles.id
    - Use p_user_id directly for all foreign key references
    - All foreign keys (approved_by, created_by, performed_by) reference user_profiles.user_id
