/*
  # Fix approve_estimate - add work_order_id to work_order_line_items insert

  ## Summary
  work_order_line_items has a NOT NULL constraint on work_order_id, but the
  function was not supplying it. This fix passes v_work_order_id when inserting
  line items.
*/
