/*
  # Fix approve_estimate function - remove non-existent columns

  ## Summary
  The approve_estimate function was referencing columns that don't exist on the
  work_orders table: priority, scheduled_start_date, estimated_completion_date,
  internal_notes. This migration recreates the function without those columns and
  also carries over surcharge fields and customer_vessel_id.
*/
