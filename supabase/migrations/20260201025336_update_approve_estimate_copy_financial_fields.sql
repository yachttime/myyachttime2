/*
  # Update Approve Estimate Function to Copy Financial Fields

  1. Changes
    - Update approve_estimate function to copy all financial fields from estimate to work order
    - This ensures taxes, shop supplies, park fees, and surcharges are preserved
*/

-- Update function to approve estimate and convert to work order
...
BEGIN
  ...
  -- Create work order with all financial fields
