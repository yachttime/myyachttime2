/*
  # Fix approve_estimate to use correct purchase_orders schema

  ## Summary
  Updates the approve_estimate function to match the actual purchase_orders table schema:
  - Status values: pending, ordered, partially_received, received, cancelled
  - Uses work_order_id (already correct), but now also sets work_order_number and all vendor/customer fields
  - PO number generation based on existing po_number column
*/
...
BEGIN
  ...
  INSERT INTO work_orders (
    work_order_number, estimate_id, yacht_id, customer_name, customer_email, customer_phone,
    ...
    v_work_order_number, p_estimate_id, v_estimate.yacht_id,
  ...
  INSERT INTO work_order_line_items (
    ...
    is_taxable, labor_code_id, part_id, line_order, work_details
  )
  SELECT
    ...
    eli.part_id, eli.line_order, eli.work_details
