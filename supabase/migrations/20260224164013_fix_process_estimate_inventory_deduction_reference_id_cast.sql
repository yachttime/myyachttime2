/*
  # Fix process_estimate_inventory_deduction - cast reference_id to uuid

  The admin_notifications.reference_id column is of type uuid, not text.
  Cast the part_id directly as uuid instead of text.
*/
