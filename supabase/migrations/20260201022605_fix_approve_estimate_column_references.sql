/*
  # Fix Approve Estimate Function Column References

  1. Changes
    - Fix column reference from estimate_task_id to task_id in estimate_line_items join
    - Fix column reference for work_order_line_items to use task_id instead of work_order_task_id
*/
