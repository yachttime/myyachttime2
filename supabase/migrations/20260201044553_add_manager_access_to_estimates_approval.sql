/*
  # Add Manager Access to Estimates Approval

  1. Changes
    - Update approve_estimate function to allow managers with can_approve_repairs permission
    - Update deny_estimate function to allow managers with can_approve_repairs permission
    - Estimates are similar to repair requests, so we use the can_approve_repairs permission
  
  2. Security
    - Managers must have can_approve_repairs = true to approve/deny estimates
    - Staff, mechanic, and master roles can still approve without additional permissions
*/

-- Update approve_estimate function to include managers with approval permission
...
-- Update deny_estimate function to include managers with approval permission
