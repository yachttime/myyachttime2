/*
  # Fix process_estimate_inventory_deduction - add required user_id to admin_notifications

  admin_notifications.user_id is NOT NULL, so we must provide it.
  Pass p_user_id into the insert.
*/
