...
-- Calculate discount amount (discount is stored as a rate, applied to subtotal)
v_discount_amount := COALESCE(v_work_order.subtotal, 0) * COALESCE(v_work_order.discount, 0);
...
COALESCE(v_work_order.park_fees_amount, 0),
v_capped_surcharge,
COALESCE(v_work_order.discount, 0),
v_capped_total,
