/*
  # Allow approving draft estimates

  Updates the approve_estimate function to allow estimates with status
  "draft" or "sent" to be approved (converted to work orders).
  Previously only "sent" status was allowed, blocking internal approvals.
*/
