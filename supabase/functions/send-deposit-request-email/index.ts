...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { repairRequestId, recipientEmail, recipientName, recaptchaToken, attachmentBase64, attachmentFilename, attachmentContentType, additionalRecipients, ccEmail }: EmailRequest = await req.json();
