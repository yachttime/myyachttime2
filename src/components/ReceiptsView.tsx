    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-sm text-blue-800">
          ...
          <p className="mt-0.5">Uploaded receipts must be approved by a manager before they are considered approved. Until approved, receipts remain in "Pending" status. Pending receipts are subject to payroll deduction. Any receipts found on your card statement not uploaded may be payroll deducted.</p>
        </div>
      </div>
